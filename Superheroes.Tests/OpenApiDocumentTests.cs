...
{
    /// <summary>
    /// Pins that the generated OpenAPI document actually describes the /battle endpoint -
    /// this is easy to silently lose, since an MVC action needs an explicit HTTP method
    /// attribute (e.g. [HttpGet]) and its controller needs [ApiController] before ASP.NET
    /// Core's API Explorer will pick it up for OpenAPI generation at all.
    /// </summary>
